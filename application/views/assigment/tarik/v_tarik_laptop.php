		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="col-lg-6">
					...
					<a href="<?php echo site_url('assigment/process_tarik/'.$jenis_barang.'/'.$as_laptop_id);?>">
					...
					<table class="table">
						<tbody>
							...
							<tr>
								<td><b>Mouse</b></td>
								<td><?php if(isset($sn_mouse)){$url_mouse = site_url('barang/detail/3/'.$id_mouse); echo "<a href=$url_mouse>".$sn_mouse."</a>";}?></td>
							</tr>
						</tbody>
					</table>
				</div>
