				...
				<div class="col-lg-6">
					...
					<form class="form-horizontal" action="<?php echo site_url($action);?>" method="POST"> 
						<div class="form-group">
							...
							<?php } ?>
							<div class="col-sm-7">
								<input type="text" class="form-control" id="user_username" name="user_username" placeholder="Username" value="<?php if(isset($user_username)){echo $user_username;}?>" <?php if($isEditing == true){echo "readonly";}?> required>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="password" class="form-control" id="user_repassword" name="user_repassword" placeholder="Re-Password" required>
							</div>
						</div>
						<div class="form-group">
