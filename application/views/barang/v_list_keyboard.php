					...
					<div class="panel-body">
						<table data-toggle="table" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    ...
						    <tr>
						        ...
						        <th data-field="service_tag" data-sortable="true"><b>Serial Number</b></th>
						    ...
						    <tbody>
						    	<?php 
						    		...
						    		foreach ($listKeyboard->result() as $row) {
						    			...
						    			echo "<td>".$row->sn."</td>";
						    			echo "<td>".$row->user."</td>";
						    			$link_edit = site_url('/edit/barang/keyboard/'.$row->id);
						    			$link_detail = site_url('/detail/barang/keyboard/'.$row->id);
						    			$link_delete = site_url('/delete/keyboard/'.$row->id);
