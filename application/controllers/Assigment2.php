	...
	public function tarik($jenis_barang = null, $id = null)
	{
		...
		if($jenis_barang == 1){
			...
			foreach ($query->result() as $row) {
				...
				if($row->location_nama != null){
					$this->data['location'] = $row->location_nama;
					if($row->cpu_sub_location != 0){
			...
			foreach ($query->result() as $row) {
				...
				if($row->location_nama != null){
					$this->data['location'] = $row->location_nama;
					if($row->smartphone_sub_location != 0){
